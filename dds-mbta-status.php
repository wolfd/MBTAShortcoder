...
if (class_exists('MBTAShortcoder')) {
    register_activation_hook("MBTAShortcoder.php", array("MBTAShortcoder", "activate"));
    register_deactivation_hook("MBTAShortcoder.php", array("MBTAShortcoder", "deactivate"));
